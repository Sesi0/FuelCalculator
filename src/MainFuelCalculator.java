		...
		tripB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					tripCostLabel.setText("<html>Òðÿáâàò Âè "
							+ String.format("%.2f", ((distance / (float) 100) * avrage))
							+ " ëèòðà ãîðèâî.<br> Öåíàòà íà ïúòóâàíåòî Âè å "
							+ String.format("%.2f", (((distance / (float) 100) * avrage) * price)) + " ëåâà.</html>");
				} catch (Exception e1) {
					JOptionPane.showMessageDialog(null, "Ìîëÿ âúâåäåòå âàëèäíî ÷èñëî!");
